...
export const ItemDetails = ({ item }: any) => {
  if (item == null)
    return (
      <div className="meli-item-details">
      ...
      <article className="meli-item-details">
        <div className="meli-grid">
          ...
          <div className="meli-column-details">
            <div>
              <div className="meli-conditions-and-sold-quantity">
                {condition} - {item.sold_quantity} vendidos
              </div>
              <h1>{item.title}</h1>
              <div className="meli-price">
                {price}
                <sup>00</sup>
              </div>

              <button className="meli-button-primary meli-width-1-1">
                Comprar
              </button>
            </div>
          </div>
